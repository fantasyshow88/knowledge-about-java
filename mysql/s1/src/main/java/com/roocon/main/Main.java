...
//		if(id > 300) {
//			if(!tableNames.contains("mytable_4")) {
//				mapper.executeQuery("create table mytable_4 (id int primary key,name varchar(10));");
//			}
//			String insertSql = "insert into mytable_4 (id , name) values ("+id+",'"+name+"')";
//			mapper.executeQuery(insertSql);
//		} else {
//			if(!tableNames.contains("mytable_1")) {
//				mapper.executeQuery("create table mytable_1 (id int primary key,name varchar(10));");
//			}
//			String insertSql = "insert into mytable_1 (id , name) values ("+id+",'"+name+"')";
//			mapper.executeQuery(insertSql);
//		}
		ac.close();
	}
