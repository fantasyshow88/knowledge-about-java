...
public class TestVolatile {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		new Thread(td).start();
//		Thread.sleep(500);
//		System.out.println(td.isI());
		while(true){
			//加锁让main线程时刻从主内存中 fresh 最新的值 ，也能达到volatile的效果，只不过锁较重
			//System.out.println(td.isFlag());//-->因为System.out.println()方法加锁了, 所以会load最新之值
//			if(td.isI()){
//				System.out.println("222222222222");
//				break;
//			}
//			System.out.println(">>" + td.getJ()); 如果加了这句,由于System.out.println()加了锁,就会load最新的值
			if(td.getJ() ==1){
				System.out.println("33333333333::" + td.getJ());
				break;
			}
