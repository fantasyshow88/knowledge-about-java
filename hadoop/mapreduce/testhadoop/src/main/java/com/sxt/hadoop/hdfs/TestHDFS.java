...
public class TestHDFS {
	...
	public void seqfile() throws Exception{
		...
		Text val = new Text();
		Option file = Writer.file(value );
		Option keyClass = Writer.keyClass(key.getClass());
		Option valueClass = Writer.valueClass(val.getClass());
		...
		Reader.Option infile = Reader.file(value);
		Reader reader = new Reader(conf,infile);
